      ...
      <div className="container mx-auto px-5 relative z-30 text-white ">
        <div className="max-w-[800px] mb-20 my-28">
          ...
          <button 
            ...
            className=" w-[400px] flex items-center gap-4 bg-[#8D86C9]  hover:[#8077d3] transition-all px-8 py-4 rounded-full font-medium active:scale-95"
          >
        ...
        {/* Hero Cards List */}
        <div className="flex gap-10 mb-4 z-20">
          ...
          </div><div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl flex flex-col justify-between h-[130px] hover:bg-white/20 transition-all group">
            <h5 className="text-gray-300 font-medium">Услуги</h5>
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-bold">Аренда кортов</h3>
              <a 
